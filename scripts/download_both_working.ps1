...
# Usage: .\scripts\download_both_working.ps1
...
if ($thumbFiles.Count -gt 0) {
    ...
    Write-Host "    Created thumbnails zip" -ForegroundColor Green
}
...
if ($rawFiles.Count -gt 0) {
    ...
    Write-Host "    Created raw images zip" -ForegroundColor Green
}
...
if ($totalCount -gt 0) {
    ...
    Write-Host "    Created combined zip" -ForegroundColor Green
}
