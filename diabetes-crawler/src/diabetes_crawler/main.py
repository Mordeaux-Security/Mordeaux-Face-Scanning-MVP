...
def setup_logging(log_level: str = "info"):
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('diabetes_crawler.log')
        ]
    )
...
Examples:
  ...
  python -m diabetes_crawler.main --sites https://example1.com https://example2.com
  
  # Health check only
  python -m diabetes_crawler.main --health-check
  
  # With custom config
  python -m diabetes_crawler.main --sites-file sites.txt --config-file custom.env
        """
    )
